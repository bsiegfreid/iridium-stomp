...
/// Re-export the high-level `Connection`, `AckMode`, and the heartbeat helper functions.
pub use connection::{AckMode, Connection, negotiate_heartbeats, parse_heartbeat_header};
